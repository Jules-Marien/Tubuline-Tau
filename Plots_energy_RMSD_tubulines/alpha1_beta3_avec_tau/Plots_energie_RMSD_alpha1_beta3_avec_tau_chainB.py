...
path_fichier_energie = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_energie/alpha1_beta3_avec_tau/Brut_score_DOPE_chainB_alpha1_beta3_avec_tau.txt'
...
path_fichier_RMSD_coeur = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_RMSD/alpha1_beta3_avec_tau/RMSD_coeurs_tubulines_alpha1_beta3_avec_tau_chainB.txt'


path_fichier_RMSD_Cter = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_RMSD/alpha1_beta3_avec_tau/RMSD_Cter_tubulines_alpha1_beta3_avec_tau_chainB.txt'
...
plt.legend()
#plt.show()
plt.savefig('Plot_energie_RMSD_coeur_tubuline_alpha1_beta3_avec_tau.png')
...
plt.legend()
#plt.show()
plt.savefig('Plot_energie_RMSD_Cter_tubuline_alpha1_beta3_avec_tau.png')
