...
path_fichier_energie = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_energie/alpha1_beta1_sans_tau/Brut_score_DOPE_chainA_beta1_sans_tau.txt'
...
path_fichier_RMSD_coeur = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_RMSD/alpha1_beta1_sans_tau/RMSD_coeurs_tubulines_alpha1_beta1_sans_tau_chainA.txt'


path_fichier_RMSD_Cter = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_RMSD/alpha1_beta1_sans_tau/RMSD_Cter_tubulines_alpha1_beta1_sans_tau_chainA.txt'
...
plt.legend()
#plt.show()
plt.savefig('Plot_energie_RMSD_coeur_tubuline_beta1_sans_tau.png')
...
plt.legend()
#plt.show()
plt.savefig('Plot_energie_RMSD_Cter_tubuline_beta1_sans_tau.png')
