...
path_fichier_energie = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_energie/alpha1_beta1_avec_tau/Brut_score_DOPE_chainA_beta1_avec_tau.txt'
...
path_fichier_RMSD_coeur = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_RMSD/alpha1_beta1_avec_tau/RMSD_coeurs_tubulines_alpha1_beta1_avec_tau_chainA.txt'


path_fichier_RMSD_Cter = '/ibpc/tethys/marien/Documents/Analyse_modeles_tubulines/Resultats_RMSD/alpha1_beta1_avec_tau/RMSD_Cter_tubulines_alpha1_beta1_avec_tau_chainA.txt'
...
#Coeur tubuline
plt.figure()
plt.title('Energie en fonction de la RMSD du coeur de la tubuline beta1 \n pour alpha1/beta1 avec Tau')
...
plt.legend()
#plt.show()
plt.savefig('Plot_energie_RMSD_coeur_tubuline_beta1_avec_tau.png')


#Cter tubuline
plt.figure()
plt.title('Energie en fonction de la RMSD de la Cter de la tubuline beta1 \n pour alpha1/beta1 avec Tau')
...
plt.legend()
#plt.show()
plt.savefig('Plot_energie_RMSD_Cter_tubuline_beta1_avec_tau.png')
